...
use App\Policies\InvoicePolicy;use App\Policies\LuggagePolicy;
use App\Policies\MaintenanceRequestPolicy;
use App\Policies\ProductPolicy;use App\Policies\RoomPolicy;
...
class AppServiceProvider extends ServiceProvider
{
    ...
    public function boot(): void
    {
        ...
        Gate::policy(Luggage::class, LuggagePolicy::class);
